...
import { DOCS_URL } from "../data/constants";
...
const DAYS = [
  {day:1,from:"Takijiri-oji",to:"Tsugizakura-oji",km:17,hours:"6–7 שעות",difficulty:"בינוני",diffColor:"#FEF3C7",diffText:"#92400E",sleep:"Tsugizakura-oji / Chikatsuyu-oji",desc:"התחלה רשמית של הטרק. הגעה מתנאבה (40 דקות אוטובוס) לנקודת ההתחלה Takijiri-oji. עלייה מדורגת ביער ברוש עתיק, מעבר ב-oji (קודש קטן) רבים לאורך הדרך.",highlights:["כניסה לאזור המורשת ביער העתיק","נקודות תצפית לאורך השביל","כמה ojis (מקדשונות קטנים) לאורך הדרך"],notes:"אוטובוס מתנאבה לTakijiri: 40 דקות. לינה בצ'יקאטסויה היא נקודת עצירה מומלצת לפני היום הכבד הבא.",link:"https://www.tb-kumano.jp/en/kumano-kodo/nakahechi/takijiri-oji-to-tsugizakura-oji/",alt:null,latlng:[33.886,135.575]},
  {day:2,from:"Tsugizakura-oji",to:"Kumano Hongu Taisha",km:21,hours:"7–8 שעות",difficulty:"קשה",diffColor:"#FEE2E2",diffText:"#991B1B",sleep:"Yunomine Onsen או Kawayu Onsen",desc:"היום הארוך והמאתגר ביותר — עלייה לגובה ואז ירידה להונגו טאישה. אפשר לפרק ליומיים עם לינה ב-Hosshinmon-oji (13 ק\"מ ביום הראשון + 8 ק\"מ ביום השני).",highlights:["מקדש Kumano Hongu Taisha — המרכזי שבשלושת הגדולים","שער הטוריי הגדול ביותר בעולם — Oyunohara","ירידה דרמטית בצד ההר אל הנהר"],notes:"מומלץ ביותר לפרק ליומיים! הירידה מ-Hosshinmon-oji להונגו נמשכת ~7 ק\"מ ושעתיים. מ-Hongu אפשר לנסוע 2 ק\"מ לאונסן Yunomine — אחד הוותיקים ביפן.",link:"https://www.tb-kumano.jp/en/kumano-kodo/nakahechi/tsugizakura-oji-to-kumano-hongu-taisha/",alt:{title:"חלופה מהחלק הזה: שיט במורד הנהר",desc:"מ-Ukegawa אפשר לשוט במורד נהר הקומנו-גאווה בסירה מסורתית (שעה וחצי) עד Kumano Hayatama Taisha. בדרך — גורג' Dorokyo עמוק ויפה מוקף יערות."},latlng:[33.839,135.788]},
  {day:3,from:"Ukegawa",to:"Koguchi",km:13,hours:"4–5 שעות",difficulty:"בינוני",diffColor:"#FEF3C7",diffText:"#92400E",sleep:"Koguchi (כפר קטן, הזמינו מראש!)",desc:"מסלול Kogumotori-goe — עלייה בהרים מיוערים עם נוף נהדר. ההתחלה ב-Ukegawa — אפשר להגיע ברגל מהונגו (~שעה) או באוטובוס.",highlights:["נוף לנהר קומנו ולהרים","יער ברוש וארז עתיק","כפר Koguchi — שקט ומבודד"],notes:"שימו לב שההתחלה היא לא בדיוק בסוף היום הקודם — יש לתכנן את המעבר ל-Ukegawa מראש.",link:"https://www.tb-kumano.jp/en/kumano-kodo/nakahechi/kogumotori-goe/",alt:null,latlng:[33.799,135.842]},
  {day:4,from:"Koguchi",to:"Kumano Nachi Taisha",km:14,hours:"5–6 שעות",difficulty:"בינוני-קשה",diffColor:"#FEE2E2",diffText:"#991B1B",sleep:"Nachi / Katsuura (עיר חוף)",desc:"המסלול Ogumotori-goe — עלייה לגובה ואז ירידה אל מפל נאצ'י ומקדש נאצ'י טאישה. אחד הסיומים הדרמטיים ביותר לכל טרק בעולם — מגיעים פנים אל פנים עם המפל הגבוה ביפן (133 מ') ומקדש שינטו עתיק.",highlights:["מפל נאצ'י (133 מ') — המפל הגבוה ביפן","מקדש Kumano Nachi Taisha + מקדש Seigantoji","ירידה במדרגות עתיקות Daimon-zaka"],notes:"הירידה מהמסלול למקדש נאצ'י דרך Daimon-zaka היא 1 ק\"מ בלבד. ב-7 בבוקר בנאצ'י יש שוק דגים עם מכירות טונה פתוחות!",link:"https://www.tb-kumano.jp/en/kumano-kodo/nakahechi/ogumotori-goe/",alt:null,latlng:[33.668,135.893]},
  {day:5,from:"Nachi",to:"Kumano Hayatama Taisha (Shingu)",km:null,hours:"אוטובוס / רכבת",difficulty:"נסיעה",diffColor:"#DBEAFE",diffText:"#1E40AF",sleep:"Shingu או חזרה לאוסקה",desc:"יום האחרון — ביקור במקדש הגדול השלישי Kumano Hayatama Taisha בשינגו, ואז נסיעה לאוסקה (כ-3 שעות). אפשר לבדוק גם את מקדש Kamikura-jinja על צלע הצוק ואת פארק Jofuku.",highlights:["Kumano Hayatama Taisha — המקדש השלישי","מקדש Kamikura-jinja על צוק","שוק הדגים של נאצ'י בבוקר מוקדם"],notes:"אוטובוס מנאצ'י לשינגו: כ-30 דקות. מסיים את מעגל שלושת מקדשי הקומנו סאנזאן.",link:"https://www.tb-kumano.jp/en/kumano-kodo/nakahechi/daimon-zaka/",alt:null,latlng:[33.726,135.986]},
];
...
export default function KumanoKodo({ onBack }: { onBack: () => void }) {
    ...
    <div className="kk" style={dark ? { background: "#111", color: "#eee" } : {}}>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: "1rem", flexWrap: "wrap", alignItems: "center" }}>
        <button onClick={onBack}
          style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "6px 14px", borderRadius: 20, border: "0.5px solid #3B82F6", background: "#EFF6FF", fontSize: 12, fontFamily: "'Heebo',sans-serif", color: "#1E40AF", cursor: "pointer", fontWeight: 500 }}>
          ← מתכנן הטיול הראשי
        </button>
            ...
            <div className="kk-toggle">
              {[4, 5, 6].map(n => (
                <button key={n} className={`kk-toggle-btn${days === n ? " active" : ""}`} onClick={() => setDays(n)}>
                  {n} ימים {n === 4 ? "(מינימום)" : n === 5 ? "(מומלץ)" : "(נינוח)"}
                </button>
              ))}
            </div>
          </div>
          ...
          {DAYS.map((d, i) => (
            <div key={i} className="kk-day">
              <div className="kk-day-header" onClick={() => setOpenDay(openDay === i ? -1 : i)}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 14, fontWeight: 600 }}>{d.from} → {d.to}</div>
